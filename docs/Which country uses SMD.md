...
| **Japan**          | ✅    | **Medium-High**                  | **Mixed (Parallel)**. 289 seats are strictly winner-take-all. Losing here doesn't affect the party's proportional seats.                         |
| **Mexico**         | ✅    | **Medium-High**                  | **Mixed (Parallel)**. 300 seats are elected via winner-take-all districts; 200 are proportional.                                                 |
| **South Korea**    | ✅    | **Medium-High**                  | **Mixed (Parallel)**. Similar to Japan; the district seats are independent winner-take-all contests.                                             |
| **Germany**        | ✅    | **Medium-Low**                   | **Mixed (MMP)**. While local candidates win their seats via winner-take-all, the *total* power of a party is corrected by the proportional vote. |
